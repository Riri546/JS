  ...
  <div class="top">
    <header class="head">
      <nav class="head__navigation">
        ...
        <div class="head__icon">
          <a class="head__icon_link" href="index.html">Home</a>
    ...
    <section class="top__info">
      <div class="top__info_content">
        ...
        <p class="top__info_text">There are many variations of the passages of lorem Ipsum fromavailable,
          majority.</p>
        <div class="button">
          <button class="button__top__info">Get Started <span class="button__img"><svg width="19" height="17"
      ...
      <figure class="element">
        ...
        <figcaption class="catalog__about">
          <div class="catalog__about__link">
            ...
            <div class="link">
              <a class="catalog__link" href="prodject.html"><svg xmlns="http://www.w3.org/2000/svg" width="70" height="70"
    ...
    <footer class="foot">
      <section class="foot__about">
        ...
        <p class="foot__text">It is a long established fact that a reader will be distracted lookings.</p>
...
.content .paper__second_title,
.content .paper__first_title,
.blog__header,
.latestPost__title,
.top .blog__title,
.top .products__title {
...
.content .paper__second_list,
.content .paper__second_text,
.content .paper__first_text,
.latestPost__text,
.subhead__link,
.top .foot__info,
.top .foot__text,
...
.content .tags__button,
.content .paper__first .date__breadcrumbs .breadcrumbs__link,
.content .paper__first .date__breadcrumbs .date,
.top .blog__item_content-date,
.top .blog__item_tag,
.top__info .button__top__info {
  color: #FFF;
  font-family: "Jost", sans-serif;
  font-size: 18px;
  font-style: normal;
...
.top .head__icon_link:hover {
  color: #CDA274;
}

.top__info_content {
  border-radius: 70px;
  background: url(../img/top__info_bac.svg), lightgray 50%/cover no-repeat;
...
.top__info .button__top__info:hover {
  background: #FFF;
  color: #292F36;
}

.top__info .button__img {
  padding-left: 10px;
}
...
.top .catalog .catalog__link {
  transition: 0.7s;
}

.top .catalog .catalog__link .catalog__link_color {
  transition: 0.7s;
}
...
.top .catalog__link:hover .catalog__link_color {
  fill: #FFF;
}
...
.top .blog .blog__item:hover {
  background: #F4F0EC;
}

.top .blog .blog__item:hover circle {
  fill: #FFF;
}
...
.top .foot__social_icon {
  transition: 0.7s;
}

.top .foot__social_icon:hover {
  fill: #CDA274;
}
...
.content .paper__first_img {
  border-radius: 70px;
  padding-bottom: 46px;
}

.content .paper__first .date__breadcrumbs {
  padding-bottom: 48px;
  display: flex;
  max-width: 804px;
  flex-direction: row;
...
.content .paper__first .date__breadcrumbs .breadcrumbs__link:hover {
  color: #CDA274;
}
...
.content .paper__first .quote__title {
  max-height: 86px;
}

.content .paper__first .quote__text {
  max-width: 400px;
  color: #CDA274;
  text-align: center;
  font-family: "DM Serif Display", serif;
...
.content .paper__second li::before {
  content: counter(num) ". ";
  /* Выводим число */
...
.content .tags__button:hover {
  color: #FFF;
  border-color: #292F36;
  background: #292F36;
}

.content .blog__list_items {
  display: grid;
  grid-template-columns: repeat(1, 350px);
  gap: 25px;
}

.content .blog__list_items .blog__list_img {
  max-width: 310px;
  margin-bottom: 15px;
  border-radius: 60px 60px 0px 0px;
}

.content .blog__list_items .blog__list_text {
  color: #292F36;
  font-family: "DM Serif Display", serif;
  font-size: 20px;
  font-style: normal;
...
.content .blog__list_items .blog__list_content {
  display: flex;
  align-items: center;
  justify-content: space-between;
}
